...
\subsection{Equipes}
Lors de ce projet, nous avons été divisés en 5 groupes différents afin de répartir les différentes compétences répartissant ainsi la charge de travail. Chaucun des groupes avaient un répondant pour les autres groupes (en gras ci-dessous).
...
\subsection{Éléments du systèmes} % Les différents capteurs, gateways, etc...

%------------------------ Biens a protéger ---------------------------------
\subsection{Biens nécessitants une protections}
les données transmises entre les différents modules
