...
De plus, l'accès au backend ainsi que l'accès au frontend ne devrait être possible que pour les personnes authorisées et authentifiées à l'aide d'un compte.
